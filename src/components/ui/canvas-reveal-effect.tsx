...
const ShaderMaterial = ({
  ...
  useFrame(({ clock }) => {
    ...
    const material = (ref.current as THREE.Mesh).material as
      | THREE.ShaderMaterial
      | undefined;
    const uniformsRecord = (material?.uniforms ?? {}) as Record<
      string,
      { value: unknown }
    >;
    const timeLocation = uniformsRecord.u_time as { value: number } | undefined;
