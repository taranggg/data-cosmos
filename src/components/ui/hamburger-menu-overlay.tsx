  ...
  return (
    ...
    >
      <style>
        {`
          ...
          .hamburger-button-${zIndex} {
            position: absolute;
            /* left/top are applied inline to respect props */
          ...
          .hamburger-button-${zIndex}::-moz-focus-inner { border: 0; }
          .hamburger-button-${zIndex} { -webkit-tap-highlight-color: transparent; }
          ...
          @media (max-width: 768px) {
            /* Keep button left/top provided by props (no forced values here) */
            .hamburger-overlay-${zIndex} {
              clip-path: circle(0px at ${buttonLeft} ${buttonTop});
            }
      ...
      <button
        ...
        style={{ left: buttonLeft, top: buttonTop, background: buttonColor }}
        onClick={toggleMenu}
